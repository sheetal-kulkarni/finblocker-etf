...
import com.example.contract.BookContract;
...
import static com.example.contract.BookContract.BOOK_CONTRACT_ID;
...
public class ETFFlow {
    ...
    public static class Initiator extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            final Command<BookContract.Commands.Create> txCommand = new Command<>(new IOUContract.Commands.Create(),
